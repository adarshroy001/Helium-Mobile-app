...
import { RootStackParamList, Product, Specification } from '../../types';
...
const ProductDetailScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const [selectedSpec, setSelectedSpec] = useState<string>('Features');

  const images: string[] = [product.image, '#c5dfd3', '#6baba5', '#90c9c4'];
  const specTabs: string[] = ['Features', 'Specifications', 'Installation'];
