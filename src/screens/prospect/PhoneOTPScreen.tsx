...
import { RootStackParamList, OTPArray } from '../../types';

type PhoneOTPScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'PhoneOTP'>;

interface Props {
  navigation: PhoneOTPScreenNavigationProp;
}

const PhoneOTPScreen: React.FC<Props> = ({ navigation }) => {
